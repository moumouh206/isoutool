...
<div class="min-h-screen bg-rs-light-gray flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <?php if ($success): ?>
    <div class="fixed top-4 left-1/2 transform -translate-x-1/2 max-w-lg w-full bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-md" role="alert">
        <div class="flex items-center">
            <svg class="w-5 h-4 mr-2  text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
