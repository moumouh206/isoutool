...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If no errors, proceed with adding review
    if (empty($errors)) {
        try {
...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-semibold text-gray-900">Ajouter un avis</h1>
...
<div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
    <span class="block sm:inline">Avis ajouté avec succès</span>
    <a href="<?= SITE_URL ?>/cp/reviews/" class="font-bold underline ml-2">Retour à la liste</a>
</div>
<?php endif; ?>
